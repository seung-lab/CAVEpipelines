...
Update the values in the example_values.yaml file, including the environment variables, the service credentials from the terraform step, and fill out the configyamls section with the location of the files to ingest and the parameters appropriate for your dataset. 
