...
## Scaling
When creating a large chunkedgraph (level 2 chunk count > `500000`), it is recommended to do it layer by layer. This is because there is simply too much information to keep track of for automatically enqueing parent chunks. This easily leads to exceeding redis memory and disrupts the process.
